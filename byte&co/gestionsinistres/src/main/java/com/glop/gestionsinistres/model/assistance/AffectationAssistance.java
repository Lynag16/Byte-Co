...
@Entity
public class AffectationAssistance {
    ...
    public AffectationAssistance() {
    }

    public AffectationAssistance(Long sinistreId, String partenaireId, LocalDate dateAffectation, String statut) {
