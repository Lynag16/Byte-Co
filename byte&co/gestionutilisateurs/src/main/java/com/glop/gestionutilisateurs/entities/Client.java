...
public class Client {
    ...
    public Client(String nom, String prenom, String email, String telephone, String motdepasse, Date dateInscription, String languePreference, String monnaiePreference, String adresseclient, String badge, String statut) {
        this.nom = nom;
        this.prenom = prenom;
        this.email = email;
        this.telephone = telephone;
